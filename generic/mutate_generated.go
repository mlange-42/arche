...
func (m *Mutate1[A]) Add(entity ecs.Entity) (ecs.Entity, *A) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate1[A]) Assign(entity ecs.Entity, a A) (ecs.Entity, *A) {
...
func (m *Mutate1[A]) getAll(entity ecs.Entity) (ecs.Entity, *A) {
...
func (m *Mutate2[A, B]) Add(entity ecs.Entity) (ecs.Entity, *A, *B) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate2[A, B]) Assign(entity ecs.Entity, a A, b B) (ecs.Entity, *A, *B) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
	)
...
func (m *Mutate2[A, B]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B) {
...
func (m *Mutate3[A, B, C]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate3[A, B, C]) Assign(entity ecs.Entity, a A, b B, c C) (ecs.Entity, *A, *B, *C) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate3[A, B, C]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C) {
...
func (m *Mutate4[A, B, C, D]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate4[A, B, C, D]) Assign(entity ecs.Entity, a A, b B, c C, d D) (ecs.Entity, *A, *B, *C, *D) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate4[A, B, C, D]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D) {
...
func (m *Mutate5[A, B, C, D, E]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate5[A, B, C, D, E]) Assign(entity ecs.Entity, a A, b B, c C, d D, e E) (ecs.Entity, *A, *B, *C, *D, *E) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate5[A, B, C, D, E]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E) {
...
func (m *Mutate6[A, B, C, D, E, F]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate6[A, B, C, D, E, F]) Assign(entity ecs.Entity, a A, b B, c C, d D, e E, f F) (ecs.Entity, *A, *B, *C, *D, *E, *F) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate6[A, B, C, D, E, F]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F) {
...
func (m *Mutate7[A, B, C, D, E, F, G]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate7[A, B, C, D, E, F, G]) Assign(entity ecs.Entity, a A, b B, c C, d D, e E, f F, g G) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate7[A, B, C, D, E, F, G]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G) {
...
func (m *Mutate8[A, B, C, D, E, F, G, H]) Add(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G, *H) {
	m.world.Add(entity, m.ids...)
	return m.getAll(entity)
}

func (m *Mutate8[A, B, C, D, E, F, G, H]) Assign(entity ecs.Entity, a A, b B, c C, d D, e E, f F, g G, h H) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G, *H) {
	m.world.AssignN(entity,
		ecs.Component{ID: m.ids[0], Component: a},
		ecs.Component{ID: m.ids[1], Component: b},
		ecs.Component{ID: m.ids[2], Component: c},
...
func (m *Mutate8[A, B, C, D, E, F, G, H]) getAll(entity ecs.Entity) (ecs.Entity, *A, *B, *C, *D, *E, *F, *G, *H) {
